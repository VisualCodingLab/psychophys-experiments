classdef csf_base < handle
    ...
    methods
        function obj = csf_base()
            ...
            gR=stimuli.gabor(obj.cic,'gabor_test'); % Gabor to display during testing (either left or right)       
            ...
            gL=stimuli.gabor(obj.cic,'gabor_adapt'); % Additional gabor to display for adapting image
